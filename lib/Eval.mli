...
val insert_edge : (string * string) -> (string * string) -> (string * string) EdgesMap.t -> (string * string) EdgesMap.t
...
val init_man : Yojson.Basic.t -> Yojson.Basic.t -> Yojson.Basic.t -> man
...
val parse_protocol_filter : string -> string -> Yojson.Basic.t -> man -> pred
