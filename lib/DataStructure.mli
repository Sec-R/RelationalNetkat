...
val nkro_equivalent : (netkat option * rel option) -> (netkat option * rel option) -> bool
val canoicalize_nkr : netkat * rel -> netkat * rel
val canoicalize_nkro : (netkat option * rel option) -> (netkat option * rel option)
...
val add_nkro_mapping : (netkat option * rel option) -> MLBDD.t -> ((netkat option * rel option) * MLBDD.t) list -> ((netkat option * rel option) * MLBDD.t) list
...
val union_nkro_mapping : ((netkat option * rel option) * MLBDD.t) list -> ((netkat option * rel option) * MLBDD.t) list -> ((netkat option * rel option) * MLBDD.t) list
...
val canonicalize_nkro_mapping : ((netkat option * rel option) * MLBDD.t) list -> ((netkat option * rel option) * MLBDD.t) list
...
val concatenate_nkro_mapping : ((netkat option * rel option) * MLBDD.t) list -> (netkat option * rel option) -> ((netkat option * rel option) * MLBDD.t) list
...
val comp_nkro_list : MLBDD.man -> pk -> pk -> (MLBDD.man -> pk -> pk -> (netkat option * rel option) -> ((netkat option * rel option) * MLBDD.t) list) -> netkat option -> rel -> rel -> ((netkat option * rel option) * MLBDD.t) list
val closure_nkro_list : MLBDD.man -> pk -> pk -> (MLBDD.man -> pk -> pk -> (netkat option * rel option) -> ((netkat option * rel option) * MLBDD.t) list) -> netkat option -> rel -> ((netkat option * rel option) * MLBDD.t) list
val epsilon_kr : MLBDD.man -> pk -> pk -> (netkat option * rel option) -> ((netkat option * rel option) * MLBDD.t) list